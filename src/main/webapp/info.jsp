...
<style type="text/css">
	...
	#eventForm .form-control-feedback {
	    ...
	    right: -15px;
			...
			<hr	style="border: 0 !important; height: 1px !important; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0) !important; background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0) !important; background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0) !important; background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0) !important;">
			...
			<script>
				function getAsistanceData(start, end) {
					$.ajax({
						url : "grid" + "?" + start + "." + end,
						type : "GET",
						dataType : "json",
			...
			<script type="text/javascript">
			    ...
			    $('#savenewappointment').click(function () {
			        ...
			        if ($("#datetimepicker").val() && $("#datetimepicker2").val()){
			        	...
			        	console.log('calling getAsistanceData');
			        	getAsistanceData(start_date.format('YYYY-MM-DD'), end_date.format('YYYY-MM-DD'));
			        }
			    });
			</script>
